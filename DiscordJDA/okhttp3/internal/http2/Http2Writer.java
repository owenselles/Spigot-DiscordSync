...
final class Http2Writer implements Closeable
{
    ...
    public synchronized void synStream(final boolean outFinished, final int streamId, final int associatedStreamId, final List<Header> headerBlock) throws IOException {
        if (this.closed) {
            throw new IOException("closed");
        }

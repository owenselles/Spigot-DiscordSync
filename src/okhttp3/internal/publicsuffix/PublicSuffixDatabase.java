...
public final class PublicSuffixDatabase
{
    ...
    private void readTheList() {
        ...
        final InputStream is = PublicSuffixDatabase.class.getClassLoader().getResourceAsStream("publicsuffixes.gz");
        if (is != null) {
            final BufferedSource bufferedSource = Okio.buffer(new GzipSource(Okio.source(is)));
            try {
